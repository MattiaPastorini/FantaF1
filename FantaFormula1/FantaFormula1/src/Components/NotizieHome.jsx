...
function timeSince(dateString) {
  ...
  if (interval >= 1)
    return interval + " anno" + (interval > 1 ? "i" : "") + " fa";
  ...
  if (interval >= 1)
    return interval + " giorno" + (interval > 1 ? "i" : "") + " fa";

  interval = Math.floor(seconds / 3600);
  if (interval >= 1)
    return interval + " ora" + (interval > 1 ? "e" : "") + " fa";

  interval = Math.floor(seconds / 60);
  if (interval >= 1)
    return interval + " minuto" + (interval > 1 ? "i" : "") + " fa";

  return "Pochi secondi fa";
}

function NotizieHome() {
